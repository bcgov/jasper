...
public class PostgresSignalRNotificationPublisher(
    IPostgresNotificationService postgresNotifications,
    PostgresSignalRBackplaneOptions backplaneOptions,
    ScvDbContext dbContext,
    ILogger<PostgresSignalRNotificationPublisher> logger) : INotificationService
{
    ...
    private readonly ILogger<PostgresSignalRNotificationPublisher> _logger = logger;
