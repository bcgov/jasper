...
public class EmailTemplate : EntityBase
{
    ...
    [
        new EmailTemplate
        {
            ...
            Subject = @"TEST - <{{ priority }}> Order Received for {{ location_shortname }} {{ case_file_number }}",
        ...
        new EmailTemplate
        {
            ...
            Subject = @"TEST - <{{ priority }}> Order {{ location_name }} {{ case_file_number }} is still waiting to be processed.",
        ...
        new EmailTemplate
        {
            ...
            Subject = @"TEST - <{{ priority }}> Order {{ location_name }} {{ case_file_number }} is overdue and has been assigned to you.",
            Body = @"Dear Judge {{ judge_name }},<br /><br />
                     The following order was received on {{ date_received }} and has not yet been completed. Please review and complete <a href='{{ url }}'>{{ location_name }} {{ case_file_number }}</a> as soon as possible.<br /><br />
                     Please select the link above to review the order.<br /><br />
                     Regards,<br />
