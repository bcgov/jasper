...
output "api_secrets" {
  value = [
    ...
    ["ORDER_MAX_REASSIGNMENT_NOTIFICATIONS", "${aws_secretsmanager_secret.misc_secret.arn}:orderMaxReassignmentNotifications::"],
    ["ORDER_MAX_REMINDER_NOTIFICATIONS", "${aws_secretsmanager_secret.misc_secret.arn}:orderMaxReminderNotifications::"],
