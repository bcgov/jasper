...
output "api_secrets" {
  value = [
    ...
    ["ORDER_MAX_REASSIGNMENT_NOTIFICATIONS", "${aws_secretsmanager_secret.order_secret.arn}:orderMaxReassignmentNotifications::"],
    ["ORDER_MAX_REMINDER_NOTIFICATIONS", "${aws_secretsmanager_secret.order_secret.arn}:orderMaxReminderNotifications::"],
    ["ORDER_REASSIGNMENT_THRESHOLD_DAYS", "${aws_secretsmanager_secret.order_secret.arn}:orderReassignmentThresholdDays::"],
    ["ORDER_REMINDER_THRESHOLD_DAYS", "${aws_secretsmanager_secret.order_secret.arn}:orderReminderThresholdDays::"],
