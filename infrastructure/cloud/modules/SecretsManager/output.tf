...
output "secrets_arn_list" {
  value = [
    ...
    aws_secretsmanager_secret.court_locations_secret.arn,
...
output "api_secrets" {
  value = [
    ...
    ["COURT_LOCATIONS__ATTACHMENT_NAME", "${aws_secretsmanager_secret.court_locations_secret.arn}:attachmentName::"],
    ["COURT_LOCATIONS__SUBJECT", "${aws_secretsmanager_secret.court_locations_secret.arn}:subject::"],
