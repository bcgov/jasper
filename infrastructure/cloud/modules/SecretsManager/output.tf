...
output "api_secrets" {
  value = [
    ...
    ["CsoKeycloakk__Client", "${aws_secretsmanager_secret.keycloak_cso_secret.arn}:client::"],
    ["CsoKeycloak__PresReqConfId", "${aws_secretsmanager_secret.keycloak_cso_secret.arn}:presReqConfId::"],
    ["CsoKeycloak__Secret", "${aws_secretsmanager_secret.keycloak_cso_secret.arn}:secret::"],
    ["CsoKeycloak__VcIdpHint", "${aws_secretsmanager_secret.keycloak_cso_secret.arn}:vcIdpHint::"],
