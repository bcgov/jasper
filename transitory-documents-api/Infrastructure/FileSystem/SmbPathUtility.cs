namespace Scv.TdApi.Infrastructure.FileSystem
{
    ...
    public static class SmbPathUtility
    {
        ...
        /// <summary>
        /// Normalizes a relative SMB path without prepending a base path.
        /// Use this for paths that are already complete (e.g., from FullPath property).
        /// Simply converts forward slashes to backslashes.
        /// </summary>
        /// <param name="relativePath">The relativePath path</param>
        /// <returns>Normalized SMB path with backslashes</returns>
        ...
        public static string NormalizePathWithForwardSlashes(string path)
        {
