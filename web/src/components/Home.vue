  ...
  <b-card bg-variant="white" class="home">
      ...
      <b-col md="6" cols="6">
        <b-card align="left" body-class="pt-1 pb-0">
          ...
          <b-card body-class="py-1">
            ...
            <b-form-input id="filenumber" v-model="fileSearch.fileNumber"
              placeholder="Enter File Number"></b-form-input>
          </b-card>
          ...
          <b-card>
            ...
            <b-form-select v-model="selectedCourtLocation" id="locationSelect" :disabled="!searchAllowed"
              :state="selectedCourtLocationState ? null : false" @change="LocationChanged"
              :options="courtRoomsAndLocations" style="height: 39px">
            </b-form-select>
          </b-card>
          <b-card class="pb-0">
    ...
    <b-modal v-model="openErrorModal" header-class="bg-warning text-light">
      ...
      <template v-slot:modal-header-close>
        <b-button variant="outline-warning" class="text-light closeButton"
          @click="openErrorModal = false">&times;</b-button>
      </template>
    </b-modal>
  </b-card>
</template>
